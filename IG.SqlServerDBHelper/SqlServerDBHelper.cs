...
namespace IG.SqlServerDBHelper
{
    ...
    public partial class SqlEngine : IDisposable
    {
        ...
        public void NonQueryInTransaction(String[] commands, List<SqlParameter[]> commandsParameters, IsolationLevel isolationLevel)
        {
            ...
            //11122008 cponz mi serve per sapere _esattamente_ che comando e' saltato
            Int32 iCommand = 0;
            ...
            try
            {
                ...
                using (SqlCommand dbCommand = new SqlCommand(commandText, dbConnection))
                {
                    ...
                    using (SqlDataReader reader = dbCommand.ExecuteReader())
                    {
                        ...
                        //cponz 27012010 - problema pagesize.. se voglio usare inferred schema e 
                        if (pageStartIndex <= 0)
                        {
                            pageStartIndex = 0;
                        }
        ...
        //cponz 19092008 - INSERIMENTO RICHIESTE
        ...
        public DataTable Query(SqlTransaction oracleTrans, String commandText, params SqlParameter[] commandParameters)
        {
            DataTable dtResults = new DataTable();
            ...
            try
            {
                ...
                using (SqlCommand dbCommand = new SqlCommand(commandText, oracleTrans.Connection, oracleTrans))
                {
